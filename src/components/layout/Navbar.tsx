    ...
    >
      <div className="flex items-center justify-between md:justify-center gap-2 md:gap-8 px-4 md:px-6 py-3 bg-[#0A0A0A]/80 backdrop-blur-xl border border-white/10 shadow-[0_0_30px_rgba(255,90,42,0.15)] rounded-full w-full">
        ...
        <Link href="/" aria-label="Home" className="flex items-center gap-2 flex-shrink-0">
          ...
          <span className="text-white font-black tracking-tighter text-base md:text-lg">BHAVESH.</span>
        </Link>
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <Link 
            href="/" 
            className={`text-xs md:text-sm font-semibold transition-colors ${pathname === "/" ? "text-white" : "text-white/70 hover:text-white"}`}
          >
            Home
          </Link>
          <Link 
            href="/projects" 
            className={`text-xs md:text-sm font-semibold transition-colors ${pathname === "/projects" ? "text-white" : "text-white/70 hover:text-white"}`}
          >
            Projects
          </Link>
        </div>
