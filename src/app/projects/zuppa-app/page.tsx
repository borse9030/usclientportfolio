...
export default function ZuppaAppCaseStudy() {
  return (
    <main className="flex flex-col w-full min-h-screen bg-[#0A0A0A] pt-32">
      ...
      <section className="w-full max-w-4xl mx-auto px-6 mb-20">
        ...
        >
          ...
          <h1 className="text-[3rem] md:text-[5rem] font-black text-white leading-[0.9] tracking-tight uppercase mb-6">
            Zuppa <span className="text-red-500">Delivery.</span>
          </h1>
      ...
      >
        <div className="relative w-full aspect-video rounded-[32px] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(239,68,68,0.1)]">
          <Image 
            src="/zuppa.jpg" 
      ...
      <section className="w-full max-w-4xl mx-auto px-6 mb-32 flex flex-col gap-16">
        <div>
          ...
          <p className="text-[#A1A1AA] text-lg leading-relaxed">
            The food delivery space is crowded with apps that feel clunky and slow. The goal with the Zuppa Delivery App was to build an interface that not only looked mouth-watering but operated with zero friction. From browsing restaurants to the final checkout step, every interaction was designed to minimize drop-off and maximize order volume.
          </p>
        </div>
        ...
        <div>
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 bg-white text-black px-8 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all duration-300"
          >
            View Live Project
